"""Evaluation metrics for the NYC Taxi Trip Duration project."""
...
def rmsle(y_true: np.ndarray, y_pred: np.ndarray) -> float:
    ...
    Negative predictions are clipped because durations cannot be negative and
    logarithms are undefined below -1.
    """
